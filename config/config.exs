...
config :discuss, DiscussWeb.Endpoint,
  ...
  live_view: [signing_salt: "pYrIghB6"]
...
config :ueberauth, Ueberauth.Strategy.Github.OAuth,
  client_id: "8acbaee683502ad0b2ea",
  client_secret: "dd2d296af59d5b7d1aa6e4e3e71c51e33d6326ff"

config :ueberauth, Ueberauth.Strategy.Facebook.OAuth,
  client_id: "542505941245500",
  client_secret: "6b34a5d850db941b0ac7ca20a62fda7f"
